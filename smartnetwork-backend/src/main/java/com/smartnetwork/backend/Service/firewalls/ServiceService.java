...
public class ServiceService {
    ...
    public com.smartnetwork.backend.domain.Entity.firewalls.Service create(CrearServiceDTO dto, String username) {
        ...
        com.smartnetwork.backend.domain.Entity.firewalls.Service service =
                new com.smartnetwork.backend.domain.Entity.firewalls.Service();
    ...
    public com.smartnetwork.backend.domain.Entity.firewalls.Service update(
            com.smartnetwork.backend.domain.Entity.firewalls.Service service,
            String username,
            Long dispositivoId) {
    ...
    public List<com.smartnetwork.backend.domain.Entity.firewalls.Service> findAllByDispositivo(
            Long dispositivoId,
            String username) {
    ...
    public Optional<com.smartnetwork.backend.domain.Entity.firewalls.Service> findById(
            Long serviceId,
            Long dispositivoId,
            String username) {
    ...
    private ServiceDTO toDTO(com.smartnetwork.backend.domain.Entity.firewalls.Service service) {
    ...
    public void eliminarService(Long serviceId, String username) {
        com.smartnetwork.backend.domain.Entity.firewalls.Service service = serviceRepository.findById(serviceId)
